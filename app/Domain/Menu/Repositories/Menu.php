    ...
    public array $menuStructures = [
        ...
        'company' => [
            10 => [
                ...
                'submenu' => [
                    5 => ['type' => 'item', 'module' => 'timesheets', 'role' => 'owner', 'title' => 'menu.all_timesheets', 'icon' => 'fa fa-fw fa-business-time', 'tooltip' => 'menu.all_timesheets_tooltip', 'href' => '/timesheets/showAll', 'active' => ['showAll']],
